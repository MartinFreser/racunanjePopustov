...
Podatki so v .csv datoteki med seboj loèeni s podpièji.
...
\caption{Psevdokoda programa}
 ...
 \KwResult{M, nmg {\color{cyan} // M-meja za avtoriziranje, nmg-namig avtorizantu}}
	...
	{\color{cyan} // s $|P_n|$ oznaèimo moè populacije $P_n$}\;
...
\begin{enumerate}
	...
	Ponavljamo za i := 1 do $stPop$ toèke 6 do 12:\\
